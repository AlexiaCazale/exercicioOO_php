<?php
	...
	{
		public function __construct(private string $restricoes = "", private string $data_nascimento = "", string $nome= '', string $cpf = '', int $ddd = 0, string $numero = '', $pessoa = null, private array $aparelho = array()){	
